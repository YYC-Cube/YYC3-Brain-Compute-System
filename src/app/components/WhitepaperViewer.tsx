...
import { 
  FileText, Cpu, Shield, Zap, Activity, Globe, Server, Layers, Database, Lock, 
  Brain, Code, Network, AlertTriangle, CheckCircle, Smartphone, PenTool, 
  ShoppingBag, BookOpen, UserCheck, Eye, Search, Scale, Wifi, Radio,
  Thermometer, Battery, Signal, HardDrive, GraduationCap, Briefcase, 
  ShoppingCart, Truck, Headset, CreditCard, PieChart, Users, TrendingUp,
  Gavel, Heart, Key, AlertOctagon, RefreshCw, BarChart, Calendar, Target,
  Handshake, Flag, Banknote, Rocket, DollarSign, Lightbulb, Anchor,
  BarChart2, PieChart as PieChartIcon, TrendingDown,
  Monitor, Layout, Settings, Bell, Menu, Grid
} from 'lucide-react';
...
function ConceptCard({ title, subtitle, items, color, icon }: any) {
  const colors: any = {
...
function LayerRow({ title, desc, icon, color }: any) {
   const colors: any = {
...
function SignalTypeRow({ type, res, invas, app }: any) {
  return (
...
function CodePanel({ children, filename }: any) {
